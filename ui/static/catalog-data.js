const AVITO_CATALOG = (function() {
  ...
  return {
    ...
    dimensionVisibility: {
      height: ["Имитация бревна, блок-хаус","Планкен","Мебельный щит","Наличник","Нащельник","Настил","Полок","Плинтус","Поддон","Потолочный плинтус, галтель","Раскладка","Рейка","Слэб","Уголок","Штапик"],
      "width-d": ["Имитация бревна, блок-хаус","Планкен","Мебельный щит","Наличник","Нащельник","Настил","Полок","Плинтус","Поддон","Потолочный плинтус, галтель","Раскладка","Рейка","Слэб","Уголок","Штапик"],
      "length-d": ["Имитация бревна, блок-хаус","Планкен","Мебельный щит","Наличник","Нащельник","Настил","Полок","Плинтус","Поддон","Потолочный плинтус, галтель","Раскладка","Рейка","Слэб","Уголок","Штапик","Лес-кругляк","Оцилиндрованное бревно","Столб для забора","Шкант"],
      diameter: ["Дрова","Лес-кругляк","Оцилиндрованное бревно","Столб для забора","Шкант","Штапик"],
      thickness: ["Доска","Брус","Брусок","Имитация бруса, рау-хаус","Вагонка"],
      width: ["Доска","Брус","Брусок","Имитация бруса, рау-хаус","Вагонка"],
      length: ["Доска","Брус","Брусок","Имитация бруса, рау-хаус","Вагонка"]
    },
    init: function() {
      setOptions(document.getElementById('wood-type'), AVITO_CATALOG.woods);
